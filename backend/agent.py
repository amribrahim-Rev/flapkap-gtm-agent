                ...
                "sequences": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "subject": {"type": "string"},
                            "preview_text": {"type": "string", "description": "Email preheader shown in inbox before opening. 40-90 chars, curiosity-driving."},
                            "email_body": {"type": "string", "description": "HTML or plain text email body. Use {{icebreaker}} as the opening personalised line."},
                ...
                "leads": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "icebreaker": {"type": "string", "description": "1-2 sentence personalised opening line for this specific lead based on their company, role and industry."},
                        },
                        "required": ["email"],
                    },
                },
